...
Beautiful AI Agent desktop application that holds all AI agents for all models. They appears as boxes on the screen and let you interact with each separately. They connect to Ollama models. I should be able to click on an agent and it does the task or takes in input in a field to perform the task.
